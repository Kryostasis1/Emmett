...
globals()['EngagementNmapTCP'] = client.containers.run("delorean", TCPNmapCommand, detach=True, remove=True, network_mode="container:Emmett", privileged=False, name="Engagementnmaptcp", labels=["Emmett","Engagement"], volumes=[DocumentsVolume, DeLoreansBuildVolume])
...
globals()['EngagementNmapUDP'] = client.containers.run("delorean", UDPNmapCommand, detach=True, remove=True, network_mode="container:Emmett", privileged=False, name="Engagementnmapudp", labels=["Emmett", "Engagement"], volumes=[DocumentsVolume, DeLoreansBuildVolume])                      
